...
export const translations = {
  en: {
    ...
    'gallery.lifeCompassAria': 'Memoway iOS app screenshots',
    'gallery.lifeCompassLightboxAria': 'Memoway screenshot gallery',
    'gallery.lifeCompassOpen': 'View screenshot larger',
    'gallery.lifeCompass1Alt': 'Memoway home screen with journey modules',
    'gallery.lifeCompass2Alt': 'Memoway memory dashboard with themes and searchable entries',
    'gallery.lifeCompass3Alt': 'Memoway goal discovery with AI-suggested next chapter',
    'gallery.lifeCompass4Alt': 'Memoway statistics insights with mood and habit metrics',
    'gallery.lifeCompass5Alt': 'Memoway German language journey progress dashboard',
  ...
  ru: {
    ...
    'gallery.lifeCompassAria': 'Скриншоты iOS-приложения Memoway',
    'gallery.lifeCompassLightboxAria': 'Галерея скриншотов Memoway',
    'gallery.lifeCompassOpen': 'Открыть скриншот крупнее',
    'gallery.lifeCompass1Alt': 'Главный экран Memoway с модулями пути',
    'gallery.lifeCompass2Alt': 'Дашборд памяти Memoway с темами и поиском записей',
    'gallery.lifeCompass3Alt': 'Открытие целей Memoway с AI-предложением следующей главы',
    'gallery.lifeCompass4Alt': 'Статистика Memoway с метриками настроения и привычек',
    'gallery.lifeCompass5Alt': 'Дашборд языкового пути Memoway для немецкого',
