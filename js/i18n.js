...
export const translations = {
  en: {
    ...
    'gallery.tennisioCopy':
      'Laptop screens from a courts and training platform: dashboard, bookings, courts, and season schedule flows.',
  ...
  ru: {
    ...
    'gallery.tennisioCopy':
      'Ноутбучные экраны платформы кортов и тренировок: дашборд, бронирования, корты и сценарии сезонного расписания.',
