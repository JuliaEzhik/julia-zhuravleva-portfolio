...
export const translations = {
  en: {
    ...
    'project3.category': 'SaaS / Product UI',
    'project3.desc':
      'Courts & training management interface: dashboard overview, court booking cards, season scheduling planner, and unmatched-player assignment flows with a clean admin system.',
    'project3.view': 'View Interface',
    'project3.tagUiUx': 'UI/UX',
    'project3.tagProduct': 'Product Interface',
    'project3.tagDashboard': 'Dashboard Design',
    'project3.tagAdmin': 'Admin Flows',
    'project4.category': 'iOS App · Coming soon',
    'project4.badge': 'Coming soon',
    'project4.desc':
      'Personal AI-enabled life OS (Python/FastAPI, web UI, native iOS). Designed and shipped end-to-end: UX, API, modular features, local privacy model.',
    'project4.view': 'Preview Screens',
    'project4.tagIos': 'iOS',
    'project4.tagUx': 'UX',
    'project4.tagApi': 'Python / FastAPI',
    'project4.tagPrivacy': 'Local Privacy',
    ...
    'gallery.tennisioEyebrow': 'Product interface',
    'gallery.tennisioCopy':
      'Sports Facility Management Platform: dashboard, bookings, courts, and season schedule flows.',
    'gallery.tennisioAria': 'Tennisio product interface laptop screenshots',
    'gallery.tennisio1Alt': 'Tennisio dashboard overview with booking stats and recent reservations',
    'gallery.tennisio2Alt': 'Tennisio season schedule planner with court timeline grid',
    'gallery.tennisio3Alt': 'Tennisio courts browse and booking cards by surface type',
    'gallery.tennisio4Alt': 'Tennisio season schedule overview with demand insights',
    'gallery.tennisio5Alt': 'Tennisio unmatched players assignment list for season schedule',
    'gallery.tennisioOpen': 'View screenshot larger',
    'gallery.lightboxAria': 'Tennisio screenshot gallery',
    'gallery.lightboxClose': 'Close gallery',
    'gallery.lightboxPrev': 'Previous screenshot',
    'gallery.lightboxNext': 'Next screenshot',
    'gallery.lifeCompassEyebrow': 'Coming soon · iOS',
    'gallery.lifeCompassCopy':
      'Personal AI-enabled life OS: journey memory, goal discovery, insights, and modular tools designed end-to-end.',
    'gallery.lifeCompassAria': 'Life Compass iOS app screenshots',
    'gallery.lifeCompassLightboxAria': 'Life Compass screenshot gallery',
    'gallery.lifeCompassOpen': 'View screenshot larger',
    'gallery.lifeCompass1Alt': 'Life Compass home screen with today\'s compass and journey modules',
    'gallery.lifeCompass2Alt': 'Life Compass memory dashboard with themes and searchable entries',
    'gallery.lifeCompass3Alt': 'Life Compass goal discovery with AI-suggested next chapter',
    'gallery.lifeCompass4Alt': 'Life Compass statistics insights with mood and habit metrics',
    'gallery.lifeCompass5Alt': 'Life Compass German language journey progress dashboard',
    ...
    'form.statusSending': 'Sending your message…',
    'form.statusSuccess': 'Message sent. Julia will reply soon.',
    'form.statusError': 'Something went wrong. Please try again or email Julia directly.',
  ...
  ru: {
    ...
    'project3.category': 'SaaS / продуктовый UI',
    'project3.desc':
      'Интерфейс управления кортами и тренировками: обзор дашборда, карточки бронирования кортов, планировщик сезона и назначение игроков без автоматической посадки в чистой админ-системе.',
    'project3.view': 'Смотреть интерфейс',
    'project3.tagUiUx': 'UI/UX',
    'project3.tagProduct': 'Продуктовый интерфейс',
    'project3.tagDashboard': 'Дизайн дашборда',
    'project3.tagAdmin': 'Админ-сценарии',
    'project4.category': 'iOS-приложение · Скоро',
    'project4.badge': 'Скоро',
    'project4.desc':
      'Персональная AI-powered life OS (Python/FastAPI, веб-UI, нативный iOS). Спроектировано и собрано end-to-end: UX, API, модульные функции и локальная модель приватности.',
    'project4.view': 'Смотреть экраны',
    'project4.tagIos': 'iOS',
    'project4.tagUx': 'UX',
    'project4.tagApi': 'Python / FastAPI',
    'project4.tagPrivacy': 'Локальная приватность',
    ...
    'gallery.tennisioEyebrow': 'Продуктовый интерфейс',
    'gallery.tennisioCopy':
      'Платформа управления спортивными объектами: дашборд, бронирования, корты и сценарии сезонного расписания.',
    'gallery.tennisioAria': 'Скриншоты интерфейса Tennisio на ноутбуке',
    'gallery.tennisio1Alt': 'Дашборд Tennisio со статистикой бронирований и последними записями',
    'gallery.tennisio2Alt': 'Планировщик сезона Tennisio с сеткой расписания по кортам',
    'gallery.tennisio3Alt': 'Каталог кортов Tennisio с карточками бронирования по типу покрытия',
    'gallery.tennisio4Alt': 'Обзор сезона Tennisio с аналитикой спроса',
    'gallery.tennisio5Alt': 'Список нераспределённых игроков Tennisio для назначения в сессию',
    'gallery.tennisioOpen': 'Открыть скриншот крупнее',
    'gallery.lightboxAria': 'Галерея скриншотов Tennisio',
    'gallery.lightboxClose': 'Закрыть галерею',
    'gallery.lightboxPrev': 'Предыдущий скриншот',
    'gallery.lightboxNext': 'Следующий скриншот',
    'gallery.lifeCompassEyebrow': 'Скоро · iOS',
    'gallery.lifeCompassCopy':
      'Персональная AI-powered life OS: память путешествия, поиск целей, инсайты и модульные инструменты, собранные end-to-end.',
    'gallery.lifeCompassAria': 'Скриншоты iOS-приложения Life Compass',
    'gallery.lifeCompassLightboxAria': 'Галерея скриншотов Life Compass',
    'gallery.lifeCompassOpen': 'Открыть скриншот крупнее',
    'gallery.lifeCompass1Alt': 'Главный экран Life Compass с компасом дня и модулями пути',
    'gallery.lifeCompass2Alt': 'Дашборд памяти Life Compass с темами и поиском записей',
    'gallery.lifeCompass3Alt': 'Открытие целей Life Compass с AI-предложением следующей главы',
    'gallery.lifeCompass4Alt': 'Статистика Life Compass с метриками настроения и привычек',
    'gallery.lifeCompass5Alt': 'Дашборд языкового пути Life Compass для немецкого',
    ...
    'form.statusSending': 'Отправляем сообщение…',
    'form.statusSuccess': 'Сообщение отправлено. Юлия скоро ответит.',
    'form.statusError': 'Что-то пошло не так. Попробуйте ещё раз или напишите Юлии на email.',
